        ...
        <div className={styles.grid}>
          ...
          <div className={`neo-card ${styles.card}`} style={{ backgroundColor: '#bfdbfe' }}>
            <div className={styles.cardIcon}>
              <svg width="22" height="22" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <BookCallButton label="Pick a time" />
          </div>
          ...
          <div className={`neo-card ${styles.card}`} style={{ backgroundColor: '#fce7f3' }}>
            ...
            <WhatsAppButton message="Hi, I'd like to discuss a project with you." label="WhatsApp me" />
          </div>
